...
#free float 44
 ...
 'ATT2_P':         {'type': ('f', 4),   'read_addr': 60,    'read_value':  -3.92,
                    ...
                    'std':1.01},
#free float 64
 'TB_ST':          {'type': PyTango.DevBoolean, 'read_addr': 68,'read_bit': 0,'read_value': False},
 'A0_ST':          {'type': PyTango.DevBoolean, 'read_addr': 68,'read_bit': 4,'read_value': False},
 'RFS_ST':         {'type': PyTango.DevBoolean, 'read_addr': 68,'read_bit': 5,'read_value': False},
#free byte 69
 'EG_ENB':         {'type': PyTango.DevBoolean, 'read_addr': 70,'read_bit': 0,'read_value': False},
 'KA_ENB':         {'type': PyTango.DevBoolean, 'read_addr': 70,'read_bit': 1,'read_value': False},
 'TL_VOK':         {'type': PyTango.DevBoolean, 'read_addr': 70,'read_bit': 2,'read_value': False},
 'IU_RDY':         {'type': PyTango.DevBoolean, 'read_addr': 70,'read_bit': 5,'read_value': False},
 'W1_UF':          {'type': PyTango.DevBoolean, 'read_addr': 70,'read_bit': 6,'read_value': False},
 'W2_UF':          {'type': PyTango.DevBoolean, 'read_addr': 70,'read_bit': 7,'read_value': False},
 'W3_UF':          {'type': PyTango.DevBoolean, 'read_addr': 71,'read_bit': 0,'read_value': False},
 'RL1_UF':         {'type': PyTango.DevBoolean, 'read_addr': 71,'read_bit': 1,'read_value': False},
 'RL2_UF':         {'type': PyTango.DevBoolean, 'read_addr': 71,'read_bit': 2,'read_value': False},
 'RL3_UF':         {'type': PyTango.DevBoolean, 'read_addr': 71,'read_bit': 3,'read_value': False},
 'UT_IS':          {'type': PyTango.DevBoolean, 'read_addr': 71,'read_bit': 4,'read_value': False},
 'MG_IS':          {'type': PyTango.DevBoolean, 'read_addr': 71,'read_bit': 5,'read_value': False},
 'GM_DI':          {'type': PyTango.DevBoolean, 'read_addr': 71,'read_bit': 6,'read_value': False},
 'LI_VOK':         {'type': PyTango.DevBoolean, 'read_addr': 71,'read_bit': 7,'read_value': False},
 'HeartBeat':      {'type': PyTango.DevBoolean, 'read_addr': 72,'read_bit': 0,'read_value': False},
 'PLC1_PR':        {'type': PyTango.DevBoolean, 'read_addr': 72,'read_bit': 2,'read_value': False},
 'PLC!_Ps':        {'type': PyTango.DevBoolean, 'read_addr': 72,'read_bit': 4,'read_value': False},
 'SF6_P1_ST':      {'type': PyTango.DevBoolean, 'read_addr': 73,'read_bit': 0,'read_value': True,},
 'SF6_P2_ST':      {'type': PyTango.DevBoolean, 'read_addr': 73,'read_bit': 1,'read_value': True},
 'KA1_OK':         {'type': PyTango.DevBoolean, 'read_addr': 73,'read_bit': 2,'read_value': False},
 'KA2_OK':         {'type': PyTango.DevBoolean, 'read_addr': 73,'read_bit': 3,'read_value': False},
 'LI_OK':          {'type': PyTango.DevBoolean, 'read_addr': 73,'read_bit': 4,'read_value': False},
 'RF_OK':          {'type': PyTango.DevBoolean, 'read_addr': 73,'read_bit': 5,'read_value': False},
...
#unknown 83
 'GUN_Filament_V': {'type': ('f', 4),   'read_addr':  84,   'read_value':  0.0,
                                        'write_addr':  0,   'write_value': 0.0},
 'GUN_Filament_I': {'type': ('f', 4),   'read_addr':  88,   'read_value':  0.0,
