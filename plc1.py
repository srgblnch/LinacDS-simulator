...
#free floats 16,20,24,28
 'GUN_HV_V':       {'type': ('f', 4),'read_addr': 32,'read_value': 0.0,
                    'updatable':True,'std': 0.25,'step':0.5,
...
#unknown 83
 ...
 'GUN_HV_V_setpoint': {'type': ('f', 4),'read_addr': 100, 'read_value': -90.0,
                                        'write_addr': 16, 'write_value':-90.0},
 'TB_GPA':         {'type': ('f', 4),  'read_addr': 104, 'read_value':  -13.0,
                                       'write_addr': 20, 'write_value': -13.0},
